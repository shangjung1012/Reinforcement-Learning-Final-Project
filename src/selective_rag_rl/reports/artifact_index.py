...
def final_project_artifact_specs(root: Path | None = None) -> list[ArtifactSpec]:
    ...
    return [
        ...
        artifact(
            "downstream_qa_gap_table",
            "evidence_boundary",
            "outputs/results/downstream_qa_gap_table.csv",
            "Machine-readable downstream QA evidence boundary table separating retrieval-stage final claims from reader diagnostics and missing policy-routed Gemini comparisons.",
            "manual gap table update from reader and Gemini-reader artifacts",
        ),
        artifact(
            "downstream_qa_gap_table_markdown",
            "evidence_boundary",
            "docs/DOWNSTREAM_QA_GAP_TABLE.md",
            "Human-readable downstream QA gap table documenting which reader comparisons are done, diagnostic-only, or still missing.",
            "manual gap table update from reader and Gemini-reader artifacts",
        ),
        artifact(
            "hotpot_policy_reader_comparison_summary",
            "reader_smoke",
            "outputs/results/hotpot_policy_reader_comparison_summary.csv",
            "HotpotQA 50-example policy-routed deterministic reader diagnostic comparing BM25, train-best fixed, and learned-policy retrieval outputs; not final QA benchmark evidence.",
        ...
        artifact(
            "hotpot_policy_reader_comparison_detailed",
            "reader_smoke",
            "outputs/results/hotpot_policy_reader_comparison_detailed.csv",
            "Per-example HotpotQA policy-routed deterministic reader diagnostic with retrieved top documents, reader predictions, EM/F1, and missing-doc counts.",
            "uv run python scripts/run_policy_reader_comparison.py --dataset hotpot --detailed-csv outputs/results/retrieval_policy_detailed.csv --num-examples 50 --readers lexical,span,answer_type --output-dir outputs/codex_policy_reader_hotpot_50 --publish-results",
        ),
        artifact(
            "nq_policy_reader_comparison_summary",
            "reader_smoke",
            "outputs/results/nq_policy_reader_comparison_summary.csv",
            "Natural Questions 50-example policy-routed deterministic reader diagnostic comparing BM25, train-best fixed, and learned-policy retrieval outputs; not final QA benchmark evidence.",
        ...
        artifact(
            "nq_policy_reader_comparison_detailed",
            "reader_smoke",
            "outputs/results/nq_policy_reader_comparison_detailed.csv",
            "Per-example Natural Questions policy-routed deterministic reader diagnostic with retrieved top documents, reader predictions, EM/F1, and missing-doc counts.",
            "uv run python scripts/run_policy_reader_comparison.py --dataset nq --detailed-csv outputs/results/nq_retrieval_policy_detailed.csv --num-examples 50 --source-num-examples 500 --readers lexical,span,answer_type --output-dir outputs/codex_policy_reader_nq_50 --publish-results",
        ),
        artifact(
            "hotpot_policy_gemini_reader_comparison_summary",
            "api_pilot",
            "outputs/results/hotpot_policy_gemini_reader_comparison_summary.csv",
            "HotpotQA 30-example policy-routed Gemini answer-reader pilot comparing BM25, train-best fixed, and learned-policy retrieval outputs; not final QA benchmark evidence.",
        ...
        artifact(
            "hotpot_policy_gemini_reader_comparison_detailed",
            "api_pilot",
            "outputs/results/hotpot_policy_gemini_reader_comparison_detailed.csv",
            "Per-example HotpotQA policy-routed Gemini answer-reader pilot with predictions, EM/F1, retrieval metrics, and missing-doc counts.",
            "CODEX_ALLOW_API_CALLS=1 uv run python scripts/run_policy_gemini_reader_comparison.py --dataset hotpot --detailed-csv outputs/results/retrieval_policy_detailed.csv --num-examples 30 --cache-path outputs/cache/codex_policy_gemini_reader_hotpot.jsonl --output-dir outputs/codex_policy_gemini_reader_hotpot_30 --allow-api --max-new-calls 75 --publish-results",
        ),
        artifact(
            "nq_policy_gemini_reader_comparison_summary",
            "api_pilot",
            "outputs/results/nq_policy_gemini_reader_comparison_summary.csv",
            "Natural Questions 30-example policy-routed Gemini answer-reader pilot comparing BM25, train-best fixed, and learned-policy retrieval outputs; not final QA benchmark evidence.",
        ...
        artifact(
            "nq_policy_gemini_reader_comparison_detailed",
            "api_pilot",
            "outputs/results/nq_policy_gemini_reader_comparison_detailed.csv",
            "Per-example Natural Questions policy-routed Gemini answer-reader pilot with predictions, EM/F1, retrieval metrics, and missing-doc counts.",
            "CODEX_ALLOW_API_CALLS=1 uv run python scripts/run_policy_gemini_reader_comparison.py --dataset nq --detailed-csv outputs/results/nq_retrieval_policy_detailed.csv --num-examples 30 --source-num-examples 500 --cache-path outputs/cache/codex_policy_gemini_reader_nq.jsonl --output-dir outputs/codex_policy_gemini_reader_nq_30 --allow-api --max-new-calls 68 --publish-results",
        ),
        artifact(
