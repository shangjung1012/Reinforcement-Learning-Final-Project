...
- [ ] Implement P0 smoke reproduction runner and docs.
- [ ] Validate P0 and commit.

## Backlog

- [ ] P0: Add `docs/FINAL_REPRODUCTION.md`.
- [ ] P0: Add `scripts/run_final_smoke.py` that avoids raw data and external APIs.
- [ ] P0: Update `.gitignore` for local venv/cache/raw-data safety.
- [ ] P0: Document smoke vs full-data reproduction in README.
