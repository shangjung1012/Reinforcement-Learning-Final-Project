...
def main() -> None:
    ...
    output_csv = args.output_csv or Path("outputs") / "results" / "selection_diagnostics.csv"
    csv_path = export_selection_diagnostics(args.grid_csv, output_csv, dataset=args.dataset)
