...
from selective_rag_rl.experiments.retrieval_policy_experiment import FEATURE_SET_CHOICES, SEMANTIC_DEPTH_DEFAULT, run_nfcorpus_retrieval_policy_experiment


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--data-path", type=Path, default=Path("data/raw/nfcorpus"))
    ...
    parser.add_argument("--generated-actions", action="store_true")
    parser.add_argument("--llm-cache-path", type=Path, default=None)
    parser.add_argument("--llm-base-cost", type=float, default=1.0)
    ...
    metadata = run_nfcorpus_retrieval_policy_experiment(
        ...
        generated_actions=args.generated_actions,
        llm_cache_path=args.llm_cache_path,
        llm_base_cost=args.llm_base_cost,
