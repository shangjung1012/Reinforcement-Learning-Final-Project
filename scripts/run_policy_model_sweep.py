...
from selective_rag_rl.experiments.policy_model_sweep import POLICY_MODEL_CHOICES, run_policy_model_sweep
...
def main() -> None:
    ...
    parser.add_argument("--policy-models", default="ridge,ridge_sweep,margin_ridge,extra_trees,random_forest,mlp,auto")
