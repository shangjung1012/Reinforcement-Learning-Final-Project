...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs") / "semantic_depth_sweep_runs")
    ...
    print(pd.read_csv(metadata["depth_effects_csv"]).to_string(index=False))
